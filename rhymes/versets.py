...
import versets_model
import verset_generator

MODEL_PATH = "model/versets_model.h5"
BATCH_SIZE = 100
...
def learn(use_tuner=False):
    train_samples = dataset_generator.count_tfrecord_samples("data/data_verset.tfrecord")
    val_samples = dataset_generator.count_tfrecord_samples("data/data_val_verset.tfrecord")
    ...
    v_model = versets_model.VersetsModel(
    ...
    train_dataset = dataset_generator.load_versets_from_tfrecord("data/data_verset.tfrecord", BATCH_SIZE, max_len_title, max_len_text, max_len_phon)
    test_dataset = dataset_generator.load_versets_from_tfrecord("data/data_val_verset.tfrecord", BATCH_SIZE, max_len_title, max_len_text, max_len_phon)
